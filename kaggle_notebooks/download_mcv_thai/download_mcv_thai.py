  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "LANGUAGE       = 'th'\n",
        "VAL_SPLIT      = 0.05   # สัดส่วนข้อมูลที่จะแบ่งไว้ทำ Validation (5%)\n",
        ...
        "import subprocess\n",
        "cmd = [\n",
        "    'torchrun', f'--nproc_per_node={nproc}', 'tools/data/data_vectorizer.py',\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "import shutil\n",
        "\n",
        "# ⚠️ ต้องย้ายกลับไปโฟลเดอร์ทำงานหลักก่อนลบ เพื่อไม่ให้เกิด Error 'cannot access parent directories'\n",
